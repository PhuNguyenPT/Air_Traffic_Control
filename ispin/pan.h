...
#define _nstates6	15	/* :init: */
#define minseq6	541
#define maxseq6	554
#define _endstate6	14

#define _nstates5	44	/* ControlTower */
#define minseq5	498
#define maxseq5	540
#define _endstate5	43

#define _nstates4	69	/* TowerOperationRequestHandler */
#define minseq4	430
#define maxseq4	497
#define _endstate4	68

#define _nstates3	13	/* Plane */
#define minseq3	418
#define maxseq3	429
#define _endstate3	12

#define _nstates2	233	/* RunwayProceduresHandler */
#define minseq2	186
#define maxseq2	417
#define _endstate2	232

#define _nstates1	39	/* PlaneParkingReplyHandler */
#define minseq1	148
#define maxseq1	185
#define _endstate1	38

#define _nstates0	149	/* RequestSubmitHandler */
#define minseq0	0
#define maxseq0	147
#define _endstate0	148
...
#endif
	unsigned _26_11_isLanding : 1;
	unsigned _26_11_isEmergency : 1;
} P6;
#define Air6	(sizeof(P6) - 3)

#define PControlTower	((P5 *)_this)
typedef struct P5 { /* ControlTower */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air5	(sizeof(P5) - Offsetof(P5, plane_id) - 1*sizeof(int))

#define PTowerOperationRequestHandler	((P4 *)_this)
typedef struct P4 { /* TowerOperationRequestHandler */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air4	(sizeof(P4) - Offsetof(P4, plane_id) - 1*sizeof(int))

#define PPlane	((P3 *)_this)
typedef struct P3 { /* Plane */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, plane_timer) - 1*sizeof(int))

#define PRunwayProceduresHandler	((P2 *)_this)
typedef struct P2 { /* RunwayProceduresHandler */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, temp_id) - 1*sizeof(int))

#define PPlaneParkingReplyHandler	((P1 *)_this)
typedef struct P1 { /* PlaneParkingReplyHandler */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, rep_parking) - 1*sizeof(int))

#define PRequestSubmitHandler	((P0 *)_this)
typedef struct P0 { /* RequestSubmitHandler */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned runway_occupied : 1;
	unsigned parking_occupied : 1;
	uchar hangar;
	uchar c_request_landing;
	uchar c_request_takeoff;
	uchar c_request_parking;
	uchar c_request_emergency;
	uchar c_reply_landing;
	uchar c_reply_takeoff;
	uchar c_reply_parking;
	uchar c_reply_emergency;
	uchar c_waiting_parking;
	uchar c_plane_log;
	uchar c_plane_request_log;
	uchar c_plane_parking_log;
	uchar c_plane_runway_log;
	uchar c_tower_log;
	uchar c_tower_reply_log;
	uchar c_emergency_log;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar emergency_occupied;
...
int Q_has(int, int, int, int, int, int, int);
